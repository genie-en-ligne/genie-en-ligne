...
class AdminVue extends Vue {
    ...
    public function afficheListeResponsables(){?>
        ...
        <div class="contenu">
            ...
            <div class="col-sm-12">
                <a href="<?php echo WEB_ROOT;?>/admin/utilisateur/ajouter-responsable" id="btnAjouterResp" class="btn btn-success col-sm-offset-11">
                    ...
                    <form id="frmAjouterResp" action="" method="POST" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-4">
                                 <a href="<?php echo WEB_ROOT;?>/admin/utilisateur/gerer-responsables" class="btn btn-danger col-sm-5" role="button">
                                    <span class="glyphicon glyphicon-remove"></span> Annuler
                                </a>
                                <button type="submit" name="subAjouterResponsable" class="btn btn-success  col-sm-5 col-sm-offset-2">
                    ...
                    <form id="frmModifierResp" action="" method="POST" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-4">
                                ...
                                <button type="submit" name="subModifierResponsable" class="btn btn-success col-sm-5 col-sm-offset-2">
    ...
    public function afficheListeCommissions(){?>
        ...
        <div class="col-sm-12">
                <a href="<?php echo WEB_ROOT.'/admin/admin/ajouter-commission/';?>" id="btnAjouterCommissions" class="btn btn-success col-sm-offset-11">
                <span class="glyphicon glyphicon-plus"></span> Ajouter</a>
        </div>
    <?php
    }
            ...
            <div class="col-sm-6 col-sm-offset-2">
                ...
                <div class="col-sm-12 col-sm-offset-1">
                    <form id="frmAjouterCommission" action="<?php echo WEB_ROOT?>/admin/admin/ajouter-commission" method="POST" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-4 ">
                                 <a href="<?php echo WEB_ROOT?>/admin/admin/gerer-commissions" class="btn btn-danger col-sm-5" role="button">
                                    <span class="glyphicon glyphicon-remove"></span> Annuler
                                </a>
                                <button type="submit" name="subAjouterCommission" class="btn btn-success col-sm-5 col-sm-offset-2 ">
                                    <span class="glyphicon glyphicon-plus"></span> Ajouter
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-4">
                                ...
                                <button type="submit" name="subModifierCommission" class="btn btn-success col-sm-5 col-sm-offset-2">
                ...
                <div class="col-sm-12 page-header">         
                    ...
                    <form id="frmSupprimerCommision" class="form-horizontal" action="<?php echo WEB_ROOT;?>/admin/admin/supprimer-commission/<?php echo $this->oCommission->getId();?>" method="POST" enctype="" role="form">
                        ...
                        <div class="form-group">
                            <label for="txtCommission" class="col-sm-4 control-label">Commission scolaire :</label>
                            <div class="col-sm-6">
                                <span id="txtCommission" class="form-control" name="mrc"><?php echo $this->oCommission->getNom();?></span>
                            </div>
                        </div>
                        <div class="form-group"></div>
                        <div class="form-group"></div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-4">
                                ...
                                <button type="submit" name="subSupprimerCommission" id="subSupprimer" class="btn btn-success col-sm-5 col-sm-offset-2">
    ...
    public function afficheListeEcoles(){?>
        ...
        <div class="col-lg-12">
            ...
            <div class="col-sm-12">
                <a href="<?php echo WEB_ROOT;?>/admin/admin/ajouter-ecole" id="btnAjouterEcole" class="btn btn-success col-sm-offset-11">
                <span class="glyphicon glyphicon-plus"></span> Ajouter</a>
            </div>
        </div> <!-- .contenu -->
        <script src="<?php echo WEB_ROOT;?>/admin/js/Admin.js"></script>
            ...
            <div class="col-sm-6 col-sm-offset-2">
                ...
                <div class="col-sm-12 col-sm-offset-1">
                    <form id="frmAjouterEcole" action="" method="POST" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-4">
                                 <a href="<?php echo WEB_ROOT;?>/admin/admin/gerer-ecoles" class="btn btn-danger col-sm-5" role="button">
                                    <span class="glyphicon glyphicon-remove"></span> Annuler
                                </a>
                                <button type="submit" name="subAjouterEcole" class="btn btn-success col-sm-5 col-sm-offset-2">
                                    <span class="glyphicon glyphicon-plus"></span> Ajouter
                                </button>
                            </div>
                        </div>
                ...
                <form id="frmModifierEcoles" action="" method="POST" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <div class="col-sm-6 col-sm-offset-4">
                            ...
                            <button type="submit" name="subModifierEcole" class="btn btn-success col-sm-5 col-sm-offset-2">
                                <span class="glyphicon glyphicon-plus"></span> Modifier
                            </button>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-sm-offset-1">
                    <form id="frmSupprimerEcole" class="form-horizontal" action="" method="POST" enctype="" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <span id="txtEcole" class="form-control" name="mrc"><?php echo $this->oEcole->getNom();?></span>
                            </div>
                        </div>
                        <div class="form-group"></div>
                        <div class="form-group"></div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-4">
                                ...
                                <button type="submit" name="subSupprimerEcole" id="subSupprimer" class="btn btn-success col-sm-5 col-sm-offset-2">
                                    <span class="glyphicon glyphicon-ok"></span> Supprimer
                                </button>
                            </div>
                        </div>
    ...
    public function afficheListeMatieres(){?>
        ...
        <div class="contenu">
            ...
            <div class="col-sm-12">
                <a href="<?php echo WEB_ROOT;?>/admin/admin/ajouter-matiere/" id="btnAjouterMatière" class="btn btn-success col-sm-offset-11">
                <span class="glyphicon glyphicon-plus"></span> Ajouter</a>
            </div>
        </div> <!-- .contenu -->
    <?php
            ...
            <div class="col-sm-6 col-sm-offset-2">
                ...
                <div class="col-sm-12 col-sm-offset-1">
                    <form id="frmAjouterMatiere" action="<?php echo WEB_ROOT;?>/admin/admin/ajouter-matiere" method="POST" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-4">
                                 <a href="<?php echo WEB_ROOT;?>/admin/admin/gerer-matieres" class="btn btn-danger col-sm-5" role="button">
                                    <span class="glyphicon glyphicon-remove"></span> Annuler
                                </a>
                                <button type="submit" name="subAjouterMatiere" class="btn btn-success col-sm-5 col-sm-offset-2">
                                    <span class="glyphicon glyphicon-plus"></span> Ajouter
                                </button>
                            </div>
                        </div>
            ...
            <div class="col-sm-6 col-sm-offset-2">
                ...
                <div class="col-sm-12 col-sm-offset-1">
                    <form id="frmModifierMatiere" action="" method="POST" class="form-horizontal" role="form">
                        ...
                        <div class="form-group"></div>
                        <div class="form-group">
                            <label for="txtNom" class="col-sm-4 control-label">Matière :</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-4">
                                ...
                                <button type="submit" name="subModifierMatiere" class="btn btn-success col-sm-5 col-sm-offset-2">
                                    <span class="glyphicon glyphicon-plus"></span> Modifier
                                </button>
                            </div>
                        </div>
                ...
                <div class="col-sm-12 col-sm-offset-1">
                    <form id="frmSupprimerMatiere" class="form-horizontal" action="" method="POST" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <span id="txtMatiere" class="form-control"><?php echo $this->oMatiere->getNom();?></span>
                            </div>
                        </div>
                        <div class="form-group"></div>
                        <div class="form-group"></div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-4">
                                ...
                                <button type="submit" name="subSupprimerMatiere" id="subSupprimer" class="btn btn-success col-sm-5 col-sm-offset-2">
                                    <span class="glyphicon glyphicon-ok"></span> Supprimer
                                </button>
                            </div>
                        </div>
    ...
    public function afficheListeProfesseurs(){?>
        ...
        <div class="row">            
            ...
            <div class="col-sm-12">
                <form id="frmChercherProf" method="GET" action="" class="form-horizontal" role="form">
                    <div class="row">
                        <div class="col-sm-5 col-sm-offset-3">
                            <label for="sltCommissions" class="col-sm-4 control-label">École :</label>
                            <div class="col-sm-6">
        ...
        <div class="col-sm-12">
            <a href="<?php echo WEB_ROOT.'/admin/utilisateur/ajouter-prof/';?>" id="btnAjouterProf" class="btn btn-success col-sm-offset-11">
            <span class="glyphicon glyphicon-plus"></span> Ajouter</a>
        </div>
        <script src="<?php echo WEB_ROOT;?>/admin/js/Admin.js"></script>
    <?php
            ...
            <div class="col-sm-6 col-sm-offset-2">
                ...
                <div class="col-sm-12 col-sm-offset-1">
                    <form id="frmAjouterProf" action="<?php echo WEB_ROOT;?>/admin/utilisateur/ajouter-prof" method="POST" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-4">
                                 <a href="<?php echo WEB_ROOT;?>/admin/utilisateur/gerer-profs" class="btn btn-danger col-sm-5" role="button">
                                    <span class="glyphicon glyphicon-remove"></span> Annuler
                                </a>
                                <button type="submit" id="subAjouterProf" name="subCreerProf" class="btn btn-success col-sm-5 col-sm-offset-2">
                                    <span class="glyphicon glyphicon-plus"></span> Ajouter
                                </button>
                            </div>
                        </div>
                    ...
                    <form id="frmModifierProf" action="<?php echo WEB_ROOT;?>/admin/utilisateur/modifier-prof/<?php echo $this->oUtilisateur->getId();?>" method="POST" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-4">
                                ...
                                <button type="submit" id="subModifierProf" name="subModifierProf" class="btn btn-success col-sm-5 col-sm-offset-2">
                                    <span class="glyphicon glyphicon-plus"></span> Modifier
                                </button>
                            </div>
                        </div>
                    ...
                    <form id="frmModifierTuteur" action="<?php echo WEB_ROOT;?>/admin/utilisateur/modifier-tuteur/<?php echo $this->oUtilisateur->getId();?>" method="POST" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-4">
                                ...
                                <button type="submit" id="subModifierTuteur" name="subModifierTuteur" class="btn btn-success col-sm-5 col-sm-offset-2">
                                    <span class="glyphicon glyphicon-plus"></span> Modifier
                                </button>
                            </div>
                        </div>
    ...
    public function afficheSupprimerUtilisateurs(){?>
        ...
        <div class="col-sm-offset-0 col-sm-12">
            ...
            <div class="col-sm-6 col-sm-offset-2">
                ...
                <div class="col-sm-12 col-sm-offset-1">
                    <form id="frmSupprimerUtilisateur" class="form-horizontal" action="" method="POST" role="form">
                        <div class="form-group"></div>
                        <div class="form-group"></div>
                        <div class="form-group"></div>
                        <div class="form-group">
                            <label for="txtPrenom" class="col-sm-4 control-label">Prénom :</label>
                            <div class="col-sm-6">
                                <span id="txtSupprimerPrenom" class="form-control" name="prenom"><?php echo $this->oUtilisateur->getPrenom();?></span>
                            </div>
                        </div>
                        <div class="form-group"></div>
                        <div class="form-group">
                            <label for="txtNom" class="col-sm-4 control-label">Nom  :</label>
                            <div class="col-sm-6">
                                <span id="txtSupprimerNom" class="form-control" name="nom"><?php echo $this->oUtilisateur->getNom();?></span>
                            </div>
                        </div>
                        <div class="form-group"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <span id="txtSupprimerRole" class="form-control" name="role"><?php echo $this->oUtilisateur->getNomRole();?></span>
                            </div>
                        </div>
                        <div class="form-group"></div>
                        <div class="form-group"></div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-4">
                                ...
                                ?>
                                 <a href="<?php echo WEB_ROOT.'/admin/utilisateur/'.$back;?>" class="btn btn-danger col-sm-5" role="button">
                                    <span class="glyphicon glyphicon-remove"></span> Annuler
                                </a>
                                <button type="submit" name="subSupprimer" id="subSupprimer" class="btn btn-success col-sm-5 col-sm-offset-2">
                                    <span class="glyphicon glyphicon-ok"></span> Supprimer
                                </button>
                            </div>
                        </div>

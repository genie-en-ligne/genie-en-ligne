                                ...
                                foreach($this->aListeUtilisateurs as $oUtilisateur){
                                    ...
                                    echo '<tr>';
                                        ...
                                        echo '<td>';
                                            ...
                                            echo '</a>';
                                            echo '<a href="'.WEB_ROOT.'/admin/supprimerUtilisateur/'.$oUtilisateur->getId().'" class="btn btn-primary btn-xs">';
                ...
                <form id="frmModifProf" acion="" method="POST" enctype="" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="email" id="txtModifPseudoResp" class="form-control" name="courriel" placeholder="Pseudo" value="<?php echo $this->oUtilisateur->getPseudo();?>">
                        </div>
                    </div>
                    <div class="form-group">
